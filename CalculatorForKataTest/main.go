...
func romanToInt(str string) (rez int, err error) {
...
func intToRoman(num int) (rom string) {
...
func stringToInt(str string) (rez int, err error) {
...
func calculate(input string) (rezult string, err error) {
...
func main() {
	...
	rezult, err := calculate(text)
	if err != nil {
		panic(err)
	}

	fmt.Println("Результат : ", rezult)
}
